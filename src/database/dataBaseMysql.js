...
async function salvarPokemons(pokemon) {
    const queryInsertPokemon = `INSERT INTO pokedex (nome, tipo, fraqueza, resistencia, hp) VALUES ('${pokemon.nome}', '${pokemon.tipo}', '${pokemon.fraqueza}', '${pokemon.resistencia}', '${pokemon.hp}')`
